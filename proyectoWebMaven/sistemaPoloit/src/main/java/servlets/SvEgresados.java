 ...
 * @author Maria
 */
@WebServlet(name = "SvEgresados", urlPatterns = {"/SvEgresados"})
public class SvEgresados extends HttpServlet {
    
    Controladora control_egre = new Controladora();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        control_egre.crearInscripcionEgresado(nombre, apellido, dni,correo, telefono,fecha_nac);
